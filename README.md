...
| 子项目 | 覆盖范围 |
|---|---|
| `*-infra`    | 构建 / lint / 打包 / CSS 工具链（TypeScript、ESLint 全家桶、Babel 全家桶、Vite/Rollup/Webpack 插件矩阵、esbuild/SWC 周边、包质量检查、Prettier/Stylelint 插件、Tailwind v3/v4、PostCSS 插件全家桶、cssnano…） |
